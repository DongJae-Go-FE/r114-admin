...
import UserContractDetailColumns from "./table-columns/UserContractDetailColumns";

import { GET_USER_CONTRACT_DETAIL_LIST_SCHEMA } from "@/modules/user/contract/model/schema";
